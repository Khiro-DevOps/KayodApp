      ...
      <PageContainer>
        <div className="space-y-5">
          <div className="flex items-center gap-3">
            <Link href="/hr" className="flex h-8 w-8 items-center justify-center rounded-xl border border-border text-text-secondary hover:bg-gray-50">
    ...
    <PageContainer>
      <div className="space-y-5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/hr/payroll/new" className="rounded-xl bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 transition-colors">
            New period
          </Link>
        </div>
