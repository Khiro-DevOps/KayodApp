...
import { InterviewCardClient } from "@/app/(dashboard)/interviews/interview-card-client";
import { InterviewCalendar } from "@/app/(dashboard)/interviews/interview-calendar";
