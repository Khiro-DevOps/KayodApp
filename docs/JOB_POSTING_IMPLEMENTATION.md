...
REDACTED_NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGc...  # from Supabase settings
REDACTED_SUPABASE_SERVICE_ROLE_KEY=eyJhbGc...       # from Supabase settings

# Gemini (for AI tailor resume)
NEXT_PUBLIC_REDACTED_GEMINI_API_KEY=your-api-key
