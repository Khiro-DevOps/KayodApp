...
```
REDACTED_DOCUSEAL_API_KEY=your_docuseal_api_key
DOCUSEAL_BASE_URL=https://api.docuseal.com
NEXT_PUBLIC_SUPABASE_URL=your_supabase_url
REDACTED_NEXT_PUBLIC_SUPABASE_ANON_KEY=your_anon_key
REDACTED_SUPABASE_SERVICE_ROLE_KEY=your_service_role_key
...
Headers: X-Auth-Token: {REDACTED_DOCUSEAL_API_KEY}
Body: {
...
- Check that `REDACTED_DOCUSEAL_API_KEY` is configured
